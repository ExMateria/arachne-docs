...
`arachne.core.dsl/id` assigns an "Arachne ID" (a qualified keyword) to an entity in the config. Arachne IDs are used pervasively to provide a human and machine-readable name to refer to config entities.
